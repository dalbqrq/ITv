...
function select_app_app_objects (id)
   local cond_ = "no.object_id = ao.service_object_id and ao.app_id = a.id and no.name1 = n.id"
   if id then
      cond_ = cond_ .. " and a.id = "..id
   end
   local tables_ = "nagios_objects no, itvision_app_objects ao, itvision_apps a, glpi_networkports n"
