...
strgs.pt_BR = {
	...
	app_object = "Objetos de uma Aplicação",
	app_tree = "Árvore de Aplicações",
...
strgs.us = {
	...
	contract = "Contract",
	app_relat_type = "Application relation type",
	app_relat = "Application's relatioships",
	app_object = "Application's objects",
	app_tree = "Application tree",
	relation = "Relation",
        version = "Version",
        created = "Created",
        updated = "Update",
