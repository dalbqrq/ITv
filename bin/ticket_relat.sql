...
#
# TICKETS NAO SOLUCIONADOS
#
# REPETICAO SOh QUE AGORA COM A CLAUSULA "t.ticketsolutiontypes_id = 0"
...
where
	...
	t.groups_id_assign = g.id and
	t.ticketcategories_id = tc.id and
	t.ticketsolutiontypes_id = 0 and
        t.itemtype = 'NetworkEquipment' and
	t.items_id = i.id;
