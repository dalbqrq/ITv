<?php
/*
 * @version $Id: notificationmail.class.php 11593 2010-06-09 22:54:39Z walid $
 -------------------------------------------------------------------------
...
class NotificationMail extends phpmailer implements NotificationInterface {
   ...
   **/
   ...
   static function testNotification() {
      ...
      $mmail->AddAddress($CFG_GLPI["admin_email"], "ITvision");
      $mmail->Subject = "[ITvision] ".$LANG['mailing'][32];
   ...
   function sendNotification($options=array()) {
      ...
      $mmail->MessageID = "ITvision-".$options["items_id"].".".time().".".rand(). "@".php_uname('n');
