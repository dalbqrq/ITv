<?php
/*
 * @version $Id: includes.php 10919 2010-03-08 18:16:28Z moyo $
 -------------------------------------------------------------------------
...
function __autoload($classname) {
   ...
   if (file_exists("$dir$item.class.php")) {
      ...
      trigger_error("ITvision autoload : file $dir$item.class.php not founded trying to load class '$classname'");
