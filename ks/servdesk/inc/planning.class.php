<?php
/*
 * @version $Id: planning.class.php 12290 2010-09-07 07:35:27Z moyo $
 -------------------------------------------------------------------------
 ...
 */
   ...
   static function generateIcal($who,$who_group) {
      ...
      if (! empty ( $CFG_GLPI["version"])) {
         $v->setConfig( 'unique_id', "ITvision-Planning-".trim($CFG_GLPI["version"]) );
      } else {
         $v->setConfig( 'unique_id', "ITvision-Planning-UnknownVersion" );
      }

      $v->setProperty( "method", "PUBLISH" );
      $v->setProperty( "version", "2.0" );
      $v->setProperty( "x-wr-calname", "ITvision".$who."_".$who_group );
