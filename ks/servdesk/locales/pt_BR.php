...
/* 
 ----------------------------------------------------------------------
 ServiceDesk - Gestionnaire Libre de Parc Informatique
 ...
 This file is part of ServiceDesk.

 ServiceDesk is free software; you can redistribute it and/or modify
 it under the terms of the GNU General Public License as published by
 the Free Software Foundation; either version 2 of the License, or
 (at your option) any later version.

 ServiceDesk is distributed in the hope that it will be useful,
 but WITHOUT ANY WARRANTY; without even the implied warranty of
 MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 GNU General Public License for more details.

 You should have received a copy of the GNU General Public License
 along with ServiceDesk; if not, write to the Free Software
...
$LANG['buttons'][40]="Árvore"; //daniel@itvision.impa.br
...
$LANG['central'][19]="Seus tickets a serem validados"; 
...
$LANG['common'][38]="Use gerenciamento unitátio"; 
$LANG['common'][39]="Duplicar os elementos o mesmo número de vezes que as conexões."; 
$LANG['common'][40]="Você realmente deseja utilizar o gerenciamento unitário para este item?"; 
...
$LANG['common'][82]="MB"; 
$LANG['common'][83]="Você não tem permissão para executar esta ação."; 
...
$LANG['common'][86]="Você não pode trocar a visibilidade da etidade filha."; 
...
$LANG['common'][92]="Nome de usuário alternativo"; 
$LANG['common'][93]="Novo filho"; 
...
$LANG['computers'][11]="ID do produto do sistema operacional"; 
$LANG['computers'][14]="Incluído"; 
$LANG['computers'][23]="Tipo de memória"; 
$LANG['computers'][24]="Memória (MB)"; 
$LANG['computers'][25]="Tamanho do Hard drive"; 
$LANG['computers'][36]="Tipo do Hard drive"; 
...
$LANG['crontask'][1]="Sincronize os equipamentos descobertos pelo OCSNG"; 
...
$LANG['crontask'][44]="Ação completada, parcialmente processada"; 
$LANG['crontask'][45]="Ação completada, completamente processada"; 
$LANG['crontask'][46]="Ação completada, nada a fazer"; 
...
$LANG['entity'][2]="RAIZ"; // daniel@itvision.com.br
...
$LANG['entity'][7]="Árvore";  // daniel@itvision.com.br
...
$LANG['entity'][17]="Fechando configuração automaticamente"; 
$LANG['entity'][18]="Fechamento automático de tickets depois"; 
...
$LANG['install'][0]="Instalar ou atualizar o ServiceDesk"; 
$LANG['install'][1]="Escolha 'Instalar' para completar a nova instalação do ServiceDesk (os dados importados pelo ServiceDesk serão os dados padrões)."; 
$LANG['install'][2]="Escolha 'Atualizar' para uma atualização do ServiceDesk a partir de uma versão formal."; 
$LANG['install'][3]="Instalar"; 
$LANG['install'][4]="Atualizar"; 
$LANG['install'][5]="Checando compatibilidade do seu ambiente com a execução do ServiceDesk"; 
...
$LANG['install'][10]="O ServiceDesk não é compatível com a opição zend.ze1_compatibility_mode = On."; 
...
$LANG['install'][64]="Usar ServiceDesk"; 
$LANG['install'][65]="Teste da extensão magic_quotes_sybase"; 
$LANG['install'][66]="ServiceDesk não trabalha com a opção magic_quotes_sybase; Favor desabilitar e tentar novamente"; 
...
$LANG['install'][69]="session.auto_start está ativo. Veja o arquivo .htaccess no diretório raiz do ServiceDesk para ter mais informações."; 
...
$LANG['install'][88]="É necessário, no mínimo, 64MB para o ServiceDesk."; 
...
$LANG['install'][103]="O ServiceDesk não trabalha corretamente sem as funções json_encode e json_decode"; 
...
$LANG['ldap'][7]="Nenhum diretório LDAP definido no ServiceDesk"; 
...
$LANG['login'][11]="Usuário não autorizado para conectar no ServiceDesk"; 
...
$LANG['login'][18]="Base interna ServiceDesk"; 
...
$LANG['login'][32]="Autenticação na base ServiceDesk"; 
...
$LANG['ocsconfig'][58]="The link automatically connects a ServiceDesk computer with one in OCSNG.<br>This option is taken into account during manual link and by synchronization scripts."; 
...
$LANG['ocsng'][3]="Clean links between ServiceDesk and OCSNG"; 
$LANG['ocsng'][4]="Link novos computadores do OCS-NG para existentes computadores no ServiceDesk"; 
...
$LANG['ocsng'][13]="Dados importados no ServiceDesk"; 
...
$LANG['ocsng'][23]="Unable to import, ServiceDesk computer is already related to an element of OCSNG"; 
...
$LANG['rulesengine'][87]="Software eliminado pelo dicionário ServiceDesk"; 
...
$LANG['rulesengine'][148]="Domínio do EMail é conhecido"; 
...
$LANG['setup'][129]="Show ServiceDesk ID"; 
...
$LANG['setup'][138]="Usar o ServiceDesk no modo"; 
...
$LANG['setup'][167]="LDAP directory / ServiceDesk links"; 
...
$LANG['setup'][302]="Você encontrará no site ServiceDesk-PROJECT.org"; 
...
$LANG['setup'][722]="Para copiar/colar em sua requisição de suporte"; 
...
$LANG['software'][46]="Associável a um ticket"; 
...
$LANG['tracking'][9]="Default para tickets"; 
$LANG['tracking'][10]="Default para recebedores de mail"; 
...
$LANG['update'][89]="Você esta tentando usar um banco de dados do ServiceDesk com uma versão mais nova do sistema. Por favor instale a versão correspondente."; 
$LANG['update'][90]="Ocorreu um erro durante a atualização do banco de dados"; 
$LANG['update'][91]="Cuidado!"; 
$LANG['update'][92]="Você atualizará o banco de dados do ServiceDesk chamado :"; 
...
$LANG['update'][106]="Voltar para o ServiceDesk"; 
...
$LANG['validation'][33]="Tickets estão esperando por sua aprovação"; 
?>
