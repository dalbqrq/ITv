...
<li><a href="/monitorbp/cgi-bin/nagios-bp.cgi" target="<?php echo $link_target;?>">BuzProc</a></li>
<li><a href="/monitorbp/cgi-bin//nagios-bp.cgi?mode=bi" target="<?php echo $link_target;?>">BuzProc BI</a></li>
<li>
