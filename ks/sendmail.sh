...
cat << EOF > client-info
AuthInfo:smtp.gmail.com "U:smmsp" "I:itvision@aditto.com.br" "P:mttp0c0s" "M:PLAIN"
AuthInfo:smtp.gmail.com:587 "U:smmsp" "I:itvision@aditto.com.br" "P:mttp0c0s" "M:PLAIN"
EOF
